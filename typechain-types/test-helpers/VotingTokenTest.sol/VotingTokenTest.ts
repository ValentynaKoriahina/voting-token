...
encodeFunctionData(functionFragment: 'addTotalSupplyForTest', values: [BigNumberish]): string;
...
encodeFunctionData(functionFragment: 'giveBalanceForTest', values: [AddressLike, BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'addTotalSupplyForTest', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'giveBalanceForTest', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'votingStartedTime', data: BytesLike): Result;
  ...
  export interface VotingTokenTest extends BaseContract {
    
    connect(runner?: ContractRunner | null): VotingTokenTest;
    waitForDeployment(): Promise<this>;

    interface: VotingTokenTestInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    addTotalSupplyForTest: TypedContractMethod<
      [amount: BigNumberish, ],
      [void],
      'nonpayable'
    >
    ...
    giveBalanceForTest: TypedContractMethod<
      [who: AddressLike, amount: BigNumberish, ],
      [void],
      'nonpayable'
    >
    ...
    getFunction(nameOrSignature: 'accumulatedFees'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'addTotalSupplyForTest'): TypedContractMethod<
      [amount: BigNumberish, ],
      [void],
      'nonpayable'
    >;
...
getFunction(nameOrSignature: 'endVoting'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'giveBalanceForTest'): TypedContractMethod<
      [who: AddressLike, amount: BigNumberish, ],
      [void],
      'nonpayable'
    >;
